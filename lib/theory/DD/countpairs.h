...
#include "countpairs.h"  /* For definition of results_countpairs */
    ...
    extern void interrupt_handler_countpairs(int signo);
    
    typedef int (*countpairs_func_ptr)(const int64_t N0, DOUBLE *x0, DOUBLE *y0, DOUBLE *z0, const weight_struct *weights0,
    ...
    extern int countpairs(const int64_t ND1, DOUBLE *X1, DOUBLE *Y1, DOUBLE *Z1,
