...
static inline DOUBLE FAST_ACOS(const DOUBLE x) {
    /* Taken from
     * http://www.geometrictools.com/GTEngine/Include/Mathematics/GteConstants.h */
    ...
    /* Faster but with a larger error bound than the alternate FAST_ACOS implementation
     * above */
