...
extern int get_gridsize(DOUBLE *xgridsize, int *nlattice,
                                const DOUBLE xdiff,
                                const DOUBLE xwrap,
                                const DOUBLE rmax,
                                const int refine_factor, const int max_ncells
...
extern void get_max_min_ra_dec(const int64_t ND1, const DOUBLE *RA, const DOUBLE *DEC,
                                        DOUBLE *ra_min, DOUBLE *dec_min, DOUBLE *ra_max, DOUBLE *dec_max);

extern DOUBLE find_closest_pos(const DOUBLE first_xbounds[2], const DOUBLE second_xbounds[2], DOUBLE *closest_pos0)__attribute__((warn_unused_result));

extern void find_min_and_max_sqr_sep_between_cell_pairs(const DOUBLE first_xbounds[2], const DOUBLE first_ybounds[2], const DOUBLE first_zbounds[2],
...
#define CHECK_AND_CONTINUE_FOR_DUPLICATE_NGB_CELLS(icell, icell2, off_xwrap, off_ywrap, off_zwrap, num_cell_pairs, num_ngb_this_cell, all_cell_pairs) { \
        ...
        for(int jj=0;jj<num_ngb_this_cell;jj++) {                       \
            struct cell_pair *this_cell_pair = &all_cell_pairs[num_cell_pairs - jj - 1]; \
